...
import { idlFactory } from './homework_diary.did.js';
export { idlFactory } from './homework_diary.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HOMEWORK_DIARY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./homework_diary.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the homework_diary canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./homework_diary.did.js")._SERVICE>}
 */
export const homework_diary = createActor(canisterId);
